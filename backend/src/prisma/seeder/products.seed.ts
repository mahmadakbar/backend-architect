...
export async function seedProducts(prisma: PrismaClient) {
  ...
  console.log(
    `✅ ${defaultProducts.length} default products seeded successfully`,
  );
  console.log(
    "📦 Products categories: Electronics, Furniture, Home Appliances, Home & Office",
  );
}
