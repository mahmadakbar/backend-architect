...
exports.productPaths = exports.productSchemas = void 0;
    ...
    CreateProductRequest: {
        ...
        properties: {
            ...
            status: {
                ...
                example: 1,
                enum: [0, 1, 2],
                description: "Product status (0: deleted, 1: active, 2: inactive, optional, default: 1)",
            },
        },
    },
    UpdateProductRequest: {
        ...
        properties: {
            ...
            status: {
                ...
                enum: [0, 1, 2],
                nullable: true,
                description: "Product status (0: deleted, 1: active, 2: inactive, optional)",
            },
        },
    },
    Product: {
...
exports.productPaths = {
    "/api/v1/products": {
        get: {
            tags: ["Products"],
            summary: "Get all products with pagination and advanced filtering",
            description: "Retrieve all products with search, filter, and sort options",
            parameters: [
                {
                    name: "page",
                    in: "query",
