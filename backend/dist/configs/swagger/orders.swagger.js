...
exports.orderPaths = exports.orderSchemas = void 0;
...
exports.orderPaths = {
    ...
    "/api/v1/orders/history": {
        get: {
            ...
            description: "Get order history for current user with search, filter, and sort. Admin/Superadmin can see all orders",
            security: [{ bearerAuth: [] }],
            parameters: [
                {
                    name: "page",
